        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full h-auto">
            <div className="lg:flex lg:justify-between">
                ...
                <div className="flex gap-2.5">
                    ...
                    <Button type="submit" className="px-6 py-2 rounded-lg bg-primary hover:bg-[#0fd60f] text-[#102210] font-bold text-sm shadow-lg shadow-green-500/20 transition-all flex items-center gap-2" label="Salvar" />
                </div>
            </div>
