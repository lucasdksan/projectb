...
export default function SignupView() {
    const { form, submit, isSubmitting } = useSignupViewModel();

    return (
        <form onSubmit={form.handleSubmit(submit)} className="space-y-6">
            <div className="space-y-1">
                <label htmlFor="name" className="text-sm font-semibold text-gray-400 ml-1">Nome Completo</label>
                <input
                    {...form.register("name")}
                    id="name"
            ...
            <div className="space-y-1">
                <label htmlFor="password" className="text-sm font-semibold text-gray-400 ml-1">Senha</label>
                <input
