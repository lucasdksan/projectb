    ...
    return(
        <div className="w-full h-full flex flex-col p-4">
            ...
            <nav className="flex-1 overflow-y-auto py-6 gap-2 flex flex-col">
                ...
                <Link href="/dashboard/contentAI" className="flex items-center px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-50 transition-colors group">Conteúdo IA</Link>
